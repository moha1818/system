...
<script type="text/javascript" src="js/systemconfig/preferentialType.js"></script>
<link rel="stylesheet" type="text/css" href="css/System configuration management/preferentialType.css">
<s:if test="msg!=null">
...
<body>
	...
	<div>
		<div  class="add">
			<input type="image" src="image/u2youhui.png" border=0 />
		</div>
			...
			<s:iterator value="list" status="li">
				<tr>
					...
					<td><a href="#" class="modify1" onclick="some(this)">修改</a> |<a
						href="deleteSystemConfig?id=<s:property value="id" />&configType=<s:property value="configType" />">删除</a></td>
				</tr>
	...
	<div id="div_add" style="display: none" class="adduser">
		<form action="addSystemConfig?&configType=7" method="post">
			...
			<table class="table2">
				...
				<tr style="height: 20px">
					<td colspan="2" style="height: 14px"><span
						id="spanconfigTypeName" class="red"></span>
				</tr>
				<tr>
					<td>类型数值:</td>
					<td><s:textfield style="width: 150px;" id="configTypeValue"
							name="configTypeValue" /></td>
				</tr>
				<tr style="height: 20px">
					<td colspan="2" style="height: 14px"><span
						id="spanconfigTypeValue" class="red"></span>
				</tr>
				<tr>
					<td>实际数值:</td>
					<td><s:textfield style="width: 150px;" id="configValue"
							name="configValue" /></td>
				</tr>
				<tr style="height: 20px">
					<td colspan="2" style="height: 14px"><span
						id="spanconfigValue" class="red"></span>
				</tr>
				<tr>
					<td>是否启用:</td>
				...
				<tr style="height: 20px">
					<td colspan="2" style="height: 14px"><span id="spanisStart"
						class="red"></span></td>
				</tr>
				<tr align="center">
	...
	<div class="modify" style="display: none">
		<form id="action" method="post">
			...
			<p align="center" style="height: 15px">
				<span id="spanconfigTypeName1" class="red"></span>
			</p>
			<p align="center">
				类型数值：
				<s:textfield name="configTypeValue" value="" id="configTypeValue1" />
			</p>
			<p align="center" style="height: 15px">
				<span id="spanconfigTypeValue1" class="red"></span>
			</p>
			<p align="center">
				实际数值：
				<s:textfield name="configValue" value="" id="configValue1" />
			</p>
			<p align="center" style="height: 15px">
				<span id="spanconfigValue1" class="red"></span>
			</p>
			<p align="center">
			...
			<p align="center" style="height: 15px">
				<span id="spanisStart1" class="red"></span>
			</p>
			<p align="center">
