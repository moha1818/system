...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <h3>注册的移动云端信息</h3>
 	<table id="top-ta">
		<tr>
			<td>登录账号：<s:property value="keyword.appUserName"/></td><td>登录密码：<s:property value="keyword.appPassword"/></td>
		</tr>
		<tr>
			<td>关键词：<s:property value="keyword.keywords"/></td><td>登录地址：<s:property value="keyword.loginUrl"/></td>
		</tr>
		<tr>
			<td>客户端下载地址(IOS)：<s:property value="keyword.iosDownloadUrl"/></td><td>二维码下载地址(IOS)：<s:property value="keyword.codeIosUrl"/></td>
		</tr>
		<tr>
			<td>客户端下载地址(Android)：<s:property value="keyword.androidDownloadUrl"/></td><td>二维码下载地址(Android)：<s:property value="keyword.codeAndroidUrl"/></td>
		</tr>
		<tr>
  ...
  <h3>基本信息</h3>
	...
	<input id="bb" type="image"  src="image/portal/u4.png"/>
	<div id="end"></div>
 </body>
 </html>