...
bootstrapQ.dialog = function (options, func) {
    ...
    // ajax page
    //var html = qiao.ajax({url:options.url, dataType:'html'});//bug  kings
    var html = qiao.ajax({url: options.url, dataType: 'html', data: options.data, type: options.type});//
